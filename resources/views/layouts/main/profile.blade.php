                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul id="profile_summary">
                                ...
                                <li>Username: <span>{{Auth::user()->username}}</span>
                                </li>
                                <li>First name: <span>{{Auth::user()->first_name}}</span>
                                </li>
                                <li>Last name: <span>{{Auth::user()->last_name}}</span>
                                </li>
                        ...
                        <div class="col-md-6">
                            <p>
                                <img src="{{Auth::user()->avatar}}" alt="Image" class="img-fluid styled profile_pic">
                            </p>
                        </div>
                    </div>
                    <!-- End row -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="phone" id="email_2"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="birthday" id="email"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="zipcode" id="email"
