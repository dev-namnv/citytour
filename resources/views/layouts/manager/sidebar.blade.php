        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="#articles" data-toggle="collapse"
                   aria-expanded={{in_array(Route::current()->getName(), ['articles.index', 'articles.create']) ? "true" : "false"}} class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="collapse submenu list-unstyled {{in_array(Route::current()->getName(), ['articles.index', 'articles.create']) ? "show" : ""}}"
                    id="articles" data-parent="#accordionExample">
