<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                <a href="#dashboard" data-active="{{request()->is('manager/dashboard*') ? 'true' : 'false'}}" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled {{request()->is('manager/dashboard*') ? 'show' : ''}}" id="dashboard" data-parent="#accordionExample">
                    <li class="{{request()->is('manager/dashboard/sale') ? 'active' : ''}}">
                        <a href="{{route('dashboard-sale')}}"> Sales </a>
                    </li>
                    <li>
                        <a href="{{route('dashboard-analytic')}}"> Analytics </a>
                    </li>
                </ul>
            </li>
