<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="#articles" data-toggle="collapse" aria-expanded={{in_array(Route::current()->getName(), ['articles.index', 'articles.create']) ? "true" : "false"}} class="dropdown-toggle">
                    <div class="">
                        <span>Articles</span>
                    </div>
                    <div>
                ...
                <ul class="collapse submenu list-unstyled {{in_array(Route::current()->getName(), ['articles.index', 'articles.create']) ? "show" : ""}}" id="articles" data-parent="#accordionExample">
                    <li class={{Route::current()->getName() === 'articles.index' ? "active" : ""}}>
                        <a href="{{route('articles.index')}}"> List </a>
                    </li>
                    <li class={{Route::current()->getName() === 'articles.create' ? "active" : ""}}>
            ...
            <li class="menu">
                <a href="https://designreset.com/cork/documentation/index.html" aria-expanded="false"
                   class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
