    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="topbar">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        ...
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
                             style="background-image: url({{ asset('Libraries/Manager/media/misc/bg-1.jpg') }})">
                            <!--begin::Title-->
                            ...
                            <div class="tab-pane active show p-8" id="topbar_notifications_notifications"
                                ...
                                <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300"
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column font-weight-bold">
                                            <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Claudy
                                                Sys</a>
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column font-weight-bold">
                                            <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Bravia
                                                SAAS</a>
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column font-weight-bold">
                                            <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Express
                                                Wind</a>
                                ...
                                <div class="navi navi-hover scroll my-4" data-scroll="true" data-height="300"
                                    ...
                                    <a href="#" class="navi-item">
                                        <div class="navi-link">
                                            ...
                                            <div class="navi-text">
                                                <div class="font-weight-bold">System reboot has been successfully
                                                    completed
                                                </div>
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item dropdown-toggle-split" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img class="h-20px w-20px rounded-sm" src="{{ asset('Libraries/Manager/media/svg/flags/226-united-states.svg') }}"
                             alt=""/>
                    </div>
                </div>
                <!--end::Toggle-->
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi navi-hover py-4">
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="{{ asset('Libraries/Manager/media/svg/flags/226-united-states.svg') }}" alt=""/>
                                </span>
                        ...
                        <li class="navi-item active">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="{{ asset('Libraries/Manager/media/svg/flags/128-spain.svg') }}" alt=""/>
                                </span>
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="{{ asset('Libraries/Manager/media/svg/flags/162-germany.svg') }}" alt=""/>
                                </span>
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="{{ asset('Libraries/Manager/media/svg/flags/063-japan.svg') }}" alt=""/>
                                </span>
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="{{ asset('Libraries/Manager/media/svg/flags/195-france.svg') }}" alt=""/>
                                </span>
