<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between">
        <!--begin::Info-->
        @include('layouts.manager.breadcrumb')
        <!--end::Info-->
        <!--begin::Toolbar-->
        <div class="row col-8">
            <div class="col-lg-2 btn mt-1" onclick="$(`#form-filter`).fadeToggle('slow')">
                <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Binocular.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            ...
            <form action="?" method="GET" id="form-filter" class="col-lg-10" @if(!request()->has('type'))style="display: none"@endif>
                <div class="row">
