                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img
                                                src="{{ asset('libraries/admin/assets/img/profile-7.jpg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img
                                                src="{{ asset('libraries/admin/assets/img/profile-4.jpg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img
                                                src="{{ asset('libraries/admin/assets/img/profile-10.jpg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img
                                                src="{{ asset('libraries/admin/assets/img/profile-13.jpg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img
                                                src="{{ asset('libraries/admin/assets/img/profile-5.jpg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img
                                                src="{{ asset('libraries/admin/assets/img/profile-6.jpg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content customer-name"><img
                                                src="{{ asset('libraries/admin/assets/img/profile-11.jpg') }}"
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content product-name"><img
                                                src="{{ asset('libraries/admin/assets/img/speaker.jpg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content product-name"><img
                                                src="{{ asset('libraries/admin/assets/img/sunglass.jpg') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content product-name"><img
                                                src="{{ asset('libraries/admin/assets/img/watch.jpg') }}"
                                                alt="product">Watch
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content product-name"><img
                                                src="{{ asset('libraries/admin/assets/img/laptop.jpg') }}"
                                                alt="product">Laptop
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content product-name"><img
                                                src="{{ asset('libraries/admin/assets/img/camera.jpg') }}"
                                                alt="product">Camera
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content product-name"><img
                                                src="{{ asset('libraries/admin/assets/img/shoes.jpg') }}"
                                                alt="product">Shoes
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="td-content product-name"><img
                                                src="{{ asset('libraries/admin/assets/img/headphones.jpg') }}"
