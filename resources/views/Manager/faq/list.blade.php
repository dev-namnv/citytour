            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Danh sách FAQ
                        </h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{route('faqs.create')}}" class="btn btn-primary font-weight-bolder">Thêm mới</a>
                        <!--end::Button-->
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-checkable dataTable no-footer dtr-inline"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{\Illuminate\Support\Str::limit($faq->heading, 50)}}</td>
