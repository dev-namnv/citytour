    ...
    <div class="container">
        <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
                <h3 class="card-title">Sửa FAQ</h3>
            </div>
            <!--begin::Form-->
                ...
                <div class="card-body ">
                    <div class="col-6">
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control @error('heading') is-invalid @enderror" id="heading_faq" name="heading" value="{{old('heading', $faq->heading)}}">
                            @error('heading')
