...
@section('content')
    <div class="container bg-white pt-2 pb-5">
        ...
        {{ Form::open(['method'=>'POST','url'=>route('tour-update'),'files'=>true,'id'=>'formAddTour']) }}
        {{Form::hidden('id',$tour->id)}}
        {{Form::hidden('slug',$tour->slug)}}
        <div class="tab-content">
            <div id="tab1" class="container tab-pane active"><br>
                <div class="row">
                    <div class="col-xl-10 ml-auto">
                        <div class="form-group row fv-plugins-icon-container">
                            <label class="col-xl-2 col-lg-2 col-form-label">Tên tour<span
                            ...
                            <div class="col-lg-8 col-xl-8">
                                ...
                                {!! Form::text('name',$tour->name,['class'=>'form-control form-control-lg form-control-solid','data-label'=>'Tên tour','placeholder'=>'Tên tour','required']) !!}
                                <div class="fv-plugins-message-container"></div>
                            </div>
                        </div>
                        <div class="form-group row fv-plugins-icon-container">
                            <label class="col-xl-2 col-lg-2 col-form-label">Địa chỉ<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-8 col-xl-8">
                                ...
                                {!! Form::text('address',$tour->address,['class'=>'form-control form-control-lg form-control-solid','data-label'=>'Địa chỉ','placeholder'=>'Địa chỉ','required']) !!}
                                <div class="fv-plugins-message-container"></div>
                            </div>
                        </div>
                        <div class="form-group row fv-plugins-icon-container">
                            ...
                            <div class="col-lg-8 col-xl-8">
                                {!! Form::text('origin',$tour->origin,['class'=>'form-control form-control-lg form-control-solid','data-label'=>'Điểm xuất phát','placeholder'=>'Điểm xuất phát','required']) !!}
                                <div class="fv-plugins-message-container"></div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-xl-2 col-lg-2 col-form-label">Ảnh thu nhỏ (800x533)<span
                                    class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-3 col-xl-3">
                                <img src="{{$tour->thumbnail}}" width="120"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3 col-xl-3">
                                <img src="{{$tour->banner}}" width="120"/>
                            </div>
                        </div>
                        <div class="form-group row fv-plugins-icon-container">
                            <label class="col-xl-2 col-lg-2 col-form-label">Giá người lớn<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3 col-xl-3">
                                ...
                                {!! Form::text('adult_price',$tour->adult_price->getAmount(),['class'=>'form-control form-control-lg form-control-solid','data-label'=>'Giá người lớn','placeholder'=>'Giá người lớn','required']) !!}
                                <div class="fv-plugins-message-container"></div>
                            </div>
                            <label class="col-xl-2 col-lg-2 col-form-label text-right">Giá trẻ em<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3 col-xl-3">
                                ...
                                {!! Form::text('child_price',$tour->child_price->getAmount(),['class'=>'form-control form-control-lg form-control-solid','data-label'=>'Giá trẻ em','placeholder'=>'Giá trẻ em','required']) !!}
                                <div class="fv-plugins-message-container"></div>
                            </div>
                        </div>
                        <div class="form-group row fv-plugins-icon-container">
                            <label class="col-xl-2 col-lg-2 col-form-label">Danh mục<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-8 col-xl-8">
                                <select class="form-control bg-light" name="category_id" required
                                        data-label="Danh mục">
                        ...
                        <div class="form-group row fv-plugins-icon-container">
                            <label class="col-xl-2 col-lg-2 col-form-label">Mô tả<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-8 col-xl-8">
                                ...
                                {{--                                </textarea>--}}
                                {!! Form::textarea('description',$tour->description,['id'=>'description','class'=>'form-control form-control-lg form-control-solid','data-label'=>'Mô tả','required']) !!}
                                <div class="fv-plugins-message-container"></div>
                            </div>
                        </div>
                        <div class="form-group row fv-plugins-icon-container">
                            <label class="col-xl-2 col-lg-2 col-form-label">Ghi chú<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-8 col-xl-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8 col-xl-8 form-group text-center">
                                @foreach($tour->albums as $key => $album)
                                    <div class="d-inline-block m-2 border">
                                        <img src="{{ $album->image }}" class="rounded" width="120"/>
                                        <strong>{{$key}}</strong>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8 col-xl-8 form-group" id="sliders">
                                <div class="row">
                                    <div class="">
                                        <input type="number" name="slide_key[]" class="form-control col-2 d-inline-block" min="0" placeholder="index">
                                        <span class="text-primary">Nhập vị trí slide muốn sửa, để trống nếu muốn thêm slide.</span>
                                    </div>
                                    <div class="custom-file">
                                        <div class="col-12">
                ...
                <div class="row col-2 float-right">
                    <div class="col-lg-auto">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link btn btn-success" onclick="nextStep(1)" data-toggle="tab"
                                   href="#tab2">Tiếp theo</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div id="tab2" class="container tab-pane fade"><br>
                ...
                <div class="row" id="schedule">
                        @foreach($tour->schedules as $key => $schedule)
                            <div class="col-xl-12 ml-auto">
                                <div class="form-group row fv-plugins-icon-container">
                                    <label class="col-xl-2 col-lg-2 col-form-label">Ngày {{$key + 1}}<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-10 col-xl-10">
                                        {{ Form::hidden('schedule_id[]',$schedule->id) }}
                                        {!! Form::textarea('schedule[]',$schedule->description,['id'=>'schedule'.$key,'class'=>'form-control form-control-lg form-control-solid','data-label'=>'Lịch trình','required']) !!}
                                    </div>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="row col-2 float-right">
                    <div class="col-lg-auto">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link btn btn-success" onclick="nextStep(2)" data-toggle="tab"
                                   href="#tab3">Tiếp theo</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        @foreach($tour->batches as $key => $batch)
                            <div class="form-group row m-3 fv-plugins-icon-container">
                                <div class="col-lg-3 col-xl-3">
                                    ...
                                    {!! Form::date('batches[]',$batch->batch,['class'=>'form-control form-control-lg form-control-solid','data-label'=>'Ngày khởi hành','required']) !!}
                                </div>
                            </div>
                        @endforeach
                    </div>
