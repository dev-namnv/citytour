...
<div class="d-flex flex-column flex-root">
    <div class="error error-3 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{ asset('Libraries/Manager/media/error/bg3.jpg') }});">
        <div class="px-10 px-md-30 py-10 py-md-0 d-flex flex-column justify-content-md-center">
            ...
            <p class="display-4 font-weight-boldest text-white mb-12">Bạn đến đây bằng cách nào</p>
            <p class="font-size-h1 font-weight-boldest text-dark-75">Xin lỗi, chúng tôi dường như không thể tìm thấy trang bạn đang tìm.</p>
            <p class="font-size-h4 line-height-md">Có thể có lỗi chính tả trong URL đã nhập hoặc trang bạn đang tìm kiếm có thể không còn tồn tại.</p>
        </div>
    </div>
</div>
