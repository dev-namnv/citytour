...
Route::get('/tour/check-batch','api\TourController@checkStartTime')->name('api-check-batch');
Route::get('/tour/delete-batch','api\TourController@destroyBatch')->name('api-delete-batch');
